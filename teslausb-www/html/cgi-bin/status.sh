...
external_5v=$(vcgencmd pmic_read_adc EXT5V_V 2>/dev/null) && external_5v=${external_5v##*=} || external_5v="N/A"
rtc_batt_v=$(vcgencmd pmic_read_adc BATT_V 2>/dev/null) && rtc_batt_v=${rtc_batt_v##*=} || rtc_batt_v="N/A"
